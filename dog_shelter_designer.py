...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gender_edit.setGeometry(QtCore.QRect(130, 140, 442, 41))
        font = QtGui.QFont()
        font.setPointSize(11)
