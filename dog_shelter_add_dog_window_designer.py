...
# Form implementation generated from reading ui file 'dog_shelter_add_dog_window_designer.ui'
#
...
class Ui_AdminAddDogWindow(object):
    def setupUi(self, AdminAddDogWindow):
        ...
        AdminAddDogWindow.resize(577, 214)
        ...
        self.btn_add.setGeometry(QtCore.QRect(390, 140, 131, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.btn_add.setFont(font)
        self.btn_add.setObjectName("btn_add")
        self.btn_file = QtWidgets.QPushButton(self.centralwidget)
        self.btn_file.setGeometry(QtCore.QRect(20, 140, 261, 41))
        font = QtGui.QFont()
